...
def index():
    ...
    return render_template("index.html", habits=habits_on_date, selected_date=selected_date, completions=completions, title="Habit Tracker - Home")
...
def add_habit():
    ...
    return render_template("add_habit.html", selected_date=today, title="Habit Tracker - Add Habit")
